...
----------------------------
install nodejs on your system and run this command:
...
note: for get path of lt.cmd on your system run this command:
...
Replace <YOUR_PUBLIC_URL> with the URL generated by LocalTunnel and Replace <YOUR_BOT_TOKEN> with TELEGRAM_BOT_TOKEN in env file and execute it on browser to set webhook:
